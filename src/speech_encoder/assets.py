...
@cache
def textlesslib_checkpoints() -> dict[str, Checkpoint]:
    """From https://github.com/facebookresearch/textlesslib/blob/main/textless/checkpoint_manager/__init__.py."""
    return {
        "hubert-base-ls960": Checkpoint(
        ...
        "mhubert-base-vp_en_es_fr": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang": Checkpoint(
        ...
        "hubert-base-ls960-layer-6-kmeans-50": Checkpoint(
        ...
        "hubert-base-ls960-layer-6-kmeans-100": Checkpoint(
        ...
        "hubert-base-ls960-layer-6-kmeans-200": Checkpoint(
        ...
        "hubert-base-ls960-layer-6-kmeans-500": Checkpoint(
        ...
        "mhubert-base-vp_en_es_fr-layer-11-kmeans-1000": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-500": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-expresso-2000": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-layer-12-kmeans-2000": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-layer-12-kmeans-expresso-2000": Checkpoint(
        ...
        "mhubert-base-25hz-layer-11-kmeans-500": Checkpoint(
        ...
        "hubert-base-ls960-kmeans-50-tacotron": Checkpoint(
        ...
        "hubert-base-ls960-kmeans-100-tacotron": Checkpoint(
        ...
        "hubert-base-ls960-kmeans-200-tacotron": Checkpoint(
        ...
        "hubert-base-ls960-kmeans-50-tacotron-codes": Checkpoint(
        ...
        "hubert-base-ls960-kmeans-100-tacotron-codes": Checkpoint(
        ...
        "hubert-base-ls960-kmeans-200-tacotron-codes": Checkpoint(
        ...
        # Hifigan
        "mhubert-base-25hz-kmeans-500-hifigan": Checkpoint(
        ...
        "mhubert-base-25hz-kmeans-500-hifigan-config": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-500-hifigan": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-500-hifigan-config": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-500-hifigan-speakers": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-500-hifigan-styles": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-expresso-2000-hifigan": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-expresso-2000-hifigan-config": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-expresso-2000-hifigan-speakers": Checkpoint(
        ...
        "hubert-base-ls960-layer-9-kmeans-expresso-2000-hifigan-styles": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-kmeans-2000-hifigan": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-kmeans-2000-hifigan-config": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-kmeans-2000-hifigan-speakers": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-kmeans-2000-hifigan-styles": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-kmeans-expresso-2000-hifigan": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-kmeans-expresso-2000-hifigan-config": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-kmeans-expresso-2000-hifigan-speakers": Checkpoint(
        ...
        "mhubert-base-vp_mls_cv_8lang-kmeans-expresso-2000-hifigan-styles": Checkpoint(
        ...
        # Quantizers
        "cpc-big-ll6k-kmeans-50": Checkpoint(
        ...
        "cpc-big-ll6k-kmeans-100": Checkpoint(
        ...
        "cpc-big-ll6k-kmeans-200": Checkpoint(
        ...
        "cpc-big-ll6k-kmeans-500": Checkpoint(
        ...
        # Tacotron2
        "cpc-big-ll6k-kmeans-50-tacotron": Checkpoint(
        ...
        "cpc-big-ll6k-kmeans-100-tacotron": Checkpoint(
        ...
        "cpc-big-ll6k-kmeans-200-tacotron": Checkpoint(
        ...
        "cpc-big-ll6k-kmeans-50-tacotron-codes": Checkpoint(
        ...
        "cpc-big-ll6k-kmeans-100-tacotron-codes": Checkpoint(
        ...
        "cpc-big-ll6k-kmeans-200-tacotron-codes": Checkpoint(
...
def match_name_or_path_with_textlesslib_names(name_or_path: str | Path) -> str:
    if name_or_path in textlesslib_checkpoints():
        return textlesslib_checkpoints()[str(name_or_path)].remote_path
...
def load_hubert_fairseq_state_dict(path: str | Path) -> dict[str, torch.Tensor]:
    state_dict = _convert_state_dict(load_fairseq_checkpoint(path)["model"])
    if "label_embs_concat" in state_dict:  # Learned embeddings of the labels the for the pretraining loss
